    ...
    <div class="row gx-0">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>{{ __('header.address') }}</small>
                <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>{{__('header.phone')}}</small>
                <small class="text-light"><i class="fa fa-envelope-open me-2"></i>{{__('header.email')}}</small>
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle text-primary d-flex align-items-center" 
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="langDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('id', null, [], true) }}">
                                    <span class="flag-icon flag-icon-id"></span> {{ __('header.indonesian') }}
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">
                                    <span class="flag-icon flag-icon-gb"></span> {{ __('header.english') }}
                                </a>
                            </li>
                        </ul>
                    </div>
